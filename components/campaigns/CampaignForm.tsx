...
import { X, Award, Calendar, Target, FileText, Loader2, AlertCircle } from "lucide-react";
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-white/[0.06]">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="font-bold text-base">Post Grant Program</h2>
              <p className="text-xs text-muted-foreground">Create a new milestone-based grant program</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="px-6 py-5 space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                id="campaign-title"
                type="text"
                placeholder="e.g. Climate Research Initiative for Sub-Saharan Africa"
                value={form.title}
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              id="campaign-desc"
              placeholder="Describe your grant program, the milestones, and funding criteria..."
          ...
          {!isConnected && (
            <div className="flex items-start gap-2 px-4 py-3 rounded-lg bg-amber-500/10 border border-amber-500/20">
              ...
              <p className="text-sm text-amber-400">
                Please connect your wallet to create a grant program
              </p>
            </div>
          )}
