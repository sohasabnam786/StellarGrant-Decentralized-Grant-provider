...
export const metadata: Metadata = {
  ...
  description:
    "Launch and distribute milestone-based developer grants on the Stellar blockchain. Transparent, fast, and low-cost funding powered by Soroban smart contracts.",
  keywords: [
    "Stellar",
    "Soroban",
    "grants",
  ...
  openGraph: {
    title: "StellarGrant",
    description: "Decentralized grant funding on Stellar Testnet",
    type: "website",
  },
};
