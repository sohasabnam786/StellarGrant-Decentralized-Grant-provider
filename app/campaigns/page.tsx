  ...
  return (
    <div className="space-y-8 pb-12 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-3xl font-black tracking-tight">Grant Programs</h1>
          <p className="text-muted-foreground mt-1">
            Discover and fund decentralized grant programs on Stellar
          </p>
        </div>
      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            type="text"
            placeholder="Search grant programs by title, description, or creator..."
            value={searchTerm}
      ...
      {isLoading ? (
        ...
        <div className="glass-card p-12 text-center space-y-4">
          ...
          <div className="space-y-1">
            <h3 className="font-bold text-lg">Failed to Load Grant Programs</h3>
        ...
        <div className="glass-card p-12 text-center space-y-4">
          ...
          <div className="space-y-1">
            <h3 className="font-bold text-lg">No Grant Programs Found</h3>
            <p className="text-sm text-muted-foreground max-w-sm mx-auto">
              We couldn&apos;t find any grant programs matching your filters. Try adjusting your search query or creating a new grant program.
            </p>
          </div>
        </div>
      )}
